    ...
    >
      ...
      >
        <template #suffix>
          ...
          >
            <FSvgIcon icon="fluent:arrow-enter-left-20-filled" />
          </div>
        </template>
      </ElInput>
        ...
        <div class="result w-full" v-show="searchResult.length">
          ...
          >
            ...
            >
              ...
              <FSvgIcon v-show="isHighlighted(index)" icon="fluent:arrow-enter-left-20-filled" />
            </div>
          </div>
        </div>
        ...
        <div v-show="!searchVal && searchResult.length === 0 && historyResult.length > 0">
          ...
          <div class="mt-1.5 w-full">
            ...
            >
              ...
              >
                <FSvgIcon icon="ri:close-large-fill" class="text-xs" />
              </div>
            </div>
          </div>
        </div>
