...
<script setup lang="ts">
  ...
  const color = systemThemeColor // css v-bind
  ...
  const changeThemeColor = (color: string) => {
    ...
    settingsStore.setElementTheme(color)
    settingsStore.reload()
  }
</script>

<style scoped>
  /* 同 LoginLeftView：artpro-ui 灰阶别名映射 */
  .color-picker-expandable {
    --art-gray-300: var(--fa-gray-300);
    --art-gray-200: var(--fa-gray-200);
  }
